...
import cn.lime.entity.quality.ProcessMeasureCheckExample;
...
public interface ProcessMeasureCheckMapper {
    ...
    List<ProcessMeasureCheck> selectAllProcessMeasureCheck();

    List<ProcessMeasureCheck> likeSelectUserByRoleName(String pMeasureCheckId);
}